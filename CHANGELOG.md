...
- Root `AGENTS.md` so the Kalos repo itself is first-class in Codex

### Changed
- README now documents Codex discovery via `~/.agents/skills/`
- Skill instructions now describe host-aware instruction targets (`CLAUDE.md` in Claude Code, `AGENTS.md` in Codex)
